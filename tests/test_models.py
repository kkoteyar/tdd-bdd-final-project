...
class TestProductModel(unittest.TestCase):
    ...
    def test_serialize(self):
        ...
        self.assertIn("available", serialized_data)
        self.assertIn("category", serialized_data)

    def test_deserialize_valid_data(self):
        # Create a sample dictionary representing product data
        product_data = {
            "name": "Sample Product",
        ...
        self.assertEqual(product.category, Category.AUTOMOTIVE)  # Assuming Category is an enum

    def test_deserialize_invalid_data(self):
        # Create an instance of the Product class
        product = Product()

        # Create an invalid dictionary (missing required keys)
        invalid_data = {
            "name": "Invalid Product",
            "price": "50.00"
        }

        # Call the deserialize method and expect a DataValidationError
